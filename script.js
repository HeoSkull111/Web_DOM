...
let divBorder = document.createElement('div');
    ...
    let p1 = document.createElement('p');
        p1.append(createCharacter('G', '#0000ff'));
        p1.append(createCharacter('o', '#cc0000'));
        p1.append(createCharacter('o', '#ff9900'));
        p1.append(createCharacter('g', '#0000ff'));
        p1.append(createCharacter('l', '#009933'));
        p1.append(createCharacter('e', '#cc0000'));
